...
# --- 3. التنسيق الملكي المطور (تصغير البرواز + تكبير الشعار) ---
st.markdown("""
    <style>
    ...
    /* --- تصغير البرواز (تقليل الحواف الداخلية) --- */
    .main .block-container {
        border: 2px solid #D4AF37;
        padding: 10px 15px !important; /* تقليل المسافات لإعطاء مساحة أكبر */
        border-radius: 15px;
    ...
    .bismillah { font-family: 'Amiri', serif; font-size: 2.1em; color: #1a1a1a; text-align: center; margin-bottom: 5px; }
    
    /* --- تكبير الشعار وتوسيطه المطلق --- */
    .logo-frame {
        display: flex;
    ...
    .circular-logo {
        width: 280px !important; /* تكبير الشعار بشكل ملحوظ */
    ...
    /* تنسيق الإحصائيات */
    [data-testid="stMetric"] { background-color: #FFFDF5; border: 1px solid #D4AF37; border-radius: 8px; text-align: center; padding: 5px !important; }
...
st.markdown("<p style='text-align:center; color:#888; font-size:0.7em;'>تصميم وبرمجة: أبو فيصل للعقارات 2026</p>", unsafe_allow_html=True)